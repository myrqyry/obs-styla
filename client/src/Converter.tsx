        ...
        <div className="converter-section">
          <div className="section-header">
            ...
            <div className="section-actions">
              ...
              <button
                 className="btn-secondary btn-sm"
                 onClick={handleClear}
                disabled={isConverting || !jsonInput}
              >
                Clear
              </button>
            </div>
          ...
          <div className="convert-controls">
            <button
              ...
              disabled={!validation.valid || !jsonInput.trim() || isConverting}
            >
              {isConverting ? 'Converting...' : 'Convert to OVT'}
            </button>
          </div>
        </div>
